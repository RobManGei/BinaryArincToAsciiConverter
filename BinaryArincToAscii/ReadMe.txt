========================================================================
    KONSOLENANWENDUNG: BinaryArincToAscii-Projektübersicht
========================================================================

Diese BinaryArincToAscii-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre BinaryArincToAscii-Anwendung besteht.


BinaryArincToAscii.vcxproj
...
BinaryArincToAscii.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "BinaryArincToAscii.pch und eine 
